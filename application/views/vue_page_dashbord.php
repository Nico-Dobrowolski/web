...
<!-- Styles -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-md-offset-4 well">
          ...
          echo form_open("/index.php/WeatherNews_controller/editlieu", $attributes);?>
      ...
      <div class="card mb-4 box-shadow">
        ...
        <div class="card-body list-unstyled mt-3 mb-4">
          <div class="row list-unstyled mt-3 mb-4">
              ...
              <button type="button" onclick="location.href='<?php echo assets_url(); ?>/index.php/WeatherNews_controller/fullweather'" class="btn btn-outline-primary btn-lg btn-block">+</button>      
                <br>
          </div>
        </div>
      </div>
  ...
  <?php for ($article = 1; $article != 5; $article++){ ?> 
  ...
  <div class="container-fluid card mb-4 box-shadow">
    ...
    <div class="row"><hr class="d-sm-none">
      <div class="col-sm-4 " style="margin-top:30px">
        <?php $image = $object_news->articles[$article]->urlToImage;
          if ($image == NULL){ ?>
                <img class="rounded mx-auto d-block img-fluid"src="https://upload.wikimedia.org/wikipedia/commons/e/e6/Pas_d%27image_disponible.svg" alt="Pas d'image disponible" >
        <?php } 
        else { ?>
            <img class="rounded mx-auto d-block img-fluid" src= <?php echo $image ;?> >
         <?php } ?>
      </div> 
    ...
    <div class="row">
      ...
      <div class="col-sm-2" style="margin-bottom:30px">
        <button type="button" class="btn btn-primary btn-lg btn-block" onClick="window.open('<?php echo $object_news->articles[$article]->url; ?>')"> > </button>
      </div>
    </div>
  </div>                         
  <?php } ?> <!----------------------------------------- fin Boucle for -->
